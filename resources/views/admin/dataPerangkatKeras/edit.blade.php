...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.data-perangkat-keras.update", [$dataPerangkatKera->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="telepon">{{ trans('cruds.dataPerangkatKera.fields.telepon') }}</label>
                <input class="form-control {{ $errors->has('telepon') ? 'is-invalid' : '' }}" type="text" name="telepon" id="telepon" value="{{ old('telepon', $dataPerangkatKera->telepon) }}">
                @if($errors->has('telepon'))
                    <span class="text-danger">{{ $errors->first('telepon') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.dataPerangkatKera.fields.telepon_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="perusahaan">{{ trans('cruds.dataPerangkatKera.fields.perusahaan') }}</label>
                <input class="form-control {{ $errors->has('perusahaan') ? 'is-invalid' : '' }}" type="text" name="perusahaan" id="perusahaan" value="{{ old('perusahaan', $dataPerangkatKera->perusahaan) }}">
                @if($errors->has('perusahaan'))
                    <span class="text-danger">{{ $errors->first('perusahaan') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.dataPerangkatKera.fields.perusahaan_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="pengampu">{{ trans('cruds.dataPerangkatKera.fields.pengampu') }}</label>
                <input class="form-control {{ $errors->has('pengampu') ? 'is-invalid' : '' }}" type="text" name="pengampu" id="pengampu" value="{{ old('pengampu', $dataPerangkatKera->pengampu) }}">
                @if($errors->has('pengampu'))
                    <span class="text-danger">{{ $errors->first('pengampu') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.dataPerangkatKera.fields.pengampu_helper') }}</span>
            </div>
            <div class="form-group">
