    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.data-perangkat-keras.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('perusahaan') ? 'is-invalid' : '' }}" type="text" name="perusahaan" id="perusahaan" value="{{ old('perusahaan', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pengampu') ? 'is-invalid' : '' }}" type="text" name="pengampu" id="pengampu" value="{{ old('pengampu', '') }}">
