        ...
        <div class="form-group">
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.dataPerangkatKera.fields.telepon') }}
                        </th>
                        <td>
                            {{ $dataPerangkatKera->telepon }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                            {{ trans('cruds.dataPerangkatKera.fields.perusahaan') }}
                        </th>
                        <td>
                            {{ $dataPerangkatKera->perusahaan }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                            {{ trans('cruds.dataPerangkatKera.fields.pengampu') }}
                        </th>
                        <td>
                            {{ $dataPerangkatKera->pengampu }}
                        </td>
                    </tr>
                    <tr>
                        <th>
